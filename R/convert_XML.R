...
#'
#' @description Imports sequences from a file and places them in an XML file generated by BEAUti for use with BEAST.
#'
...
#'
#' @export
convert_XML <- function(file, datatype, template, name, dates = NULL, loc = NULL, chainLength = NULL, storeEvery = NULL) {
